    ...
    <div className="h-[35.9375rem] flex flex-col items-center justify-center text-[1.25rem] mx-[10%]">
      ...
      <div className="flex-1 flex items-center justify-between gap-[5rem]">
        ...
        <div>
          ...
          <li>
              <a href="https://www.acm.org/education" className="hover:text-[#2F92D0]">
                ACM Education
              </a>
            </li>
            <li>
              <a href="https://dl.acm.org/" className="hover:text-[#2F92D0]">
                ACM Digital Library
              </a>
            </li>
            <li>
              <a href="https://www.acm.org/code-of-ethics" className="hover:text-[#2F92D0]">
                ACM Code of Ethics
              </a>
            </li>
            <li>
              <a href="http://www.northsouth.edu/" className="hover:text-[#2F92D0]">
                NSU Website
              </a>
            </li>
            <li>
              <a href="http://ece.northsouth.edu/" className="hover:text-[#2F92D0]">
                NSU ECE Department
              </a>
            </li>
          </ul>
